"""
ProposedModelV1 — archived March 2026.

Original 8× MRI super-resolution architecture used in the "Residual III"
experiments. Kept here to reproduce results from models/pretrained/proposed.pth.

Differences from ProposedModelV2:
  - Sigmoid activation on output (clips gradients at tissue boundaries)
  - No depthwise smooth conv after PixelShuffle (checkerboard-prone)
  - Single input channel only (no temporal stacking support)
  - Parameter name is `channels` rather than `in_channels`
"""
...
class ProposedModelV1(nn.Module):
    """Original Residual III architecture (March 2026)."""
